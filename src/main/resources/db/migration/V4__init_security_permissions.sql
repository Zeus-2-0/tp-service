...
INSERT INTO tpdb.security_user(user_id, username, password, account_not_expired, account_not_locked, credentials_not_expired, enabled,created_date, updated_date) VALUES ('bb6286a4-ddf6-4731-b285-cbf532c1d316', 'api-gateway', '{bcrypt}$2a$10$xzJDVYccmrainGMGsRE8wub2jB1bRYSIeZoc/juccaJJzztdykmBm', true, true, true, true, sysdate(), sysdate());
