...
public interface TradingPartnerApi {
    ...
    ResponseEntity<TradingPartnerList> getAllTradingPartners();
    ...
    @GetMapping("/sort")
    ResponseEntity<TradingPartnerList> getAllSortedTradingPartners(
    ...
    ResponseEntity<TradingPartnerList> getTradingPartnerById(@PathVariable("tradingPartnerId") String tradingPartnerId);
}
